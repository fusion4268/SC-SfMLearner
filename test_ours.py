...
parser.add_argument("--dir_suffix", default='/left/', type=str, help="suffix of dataset directory")
...
def load_tensor_image(filename, args):
    ...
    if (not args.no_resize) and (h != args.img_height or w != args.img_width):
        #Crop image to 832 x 256
        #ystart = int((h-args.img_height)/2)
        #xstart = int((w-args.img_width)/2)
        #img = img[ystart:(ystart+args.img_height), xstart:(xstart+args.img_width)]

        #Crop hegith and resize image
        img = img[20:340 , 0:640]
...
def main():
    ...
    image_dir = Path(args.dataset_dir + args.sequence + args.dir_suffix)
